...
head(pml.training.csv)

str(pml.testing.csv)
head(pml.testing.csv)
```
...
Decision Tree: `r round(cm.testing.rpart$overall['Accuracy'],4)`

Random Forest: `r round(cm.testing.rf$overall['Accuracy'],4)`

Generalized Boosted Regression: `r round(cm.testing.gbm$overall['Accuracy'],4)`

Finally, the model with the highest accuracy (Random Forest) will be applied on validation data.
